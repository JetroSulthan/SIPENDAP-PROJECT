...
<div class="bg-[#72B944] flex flex-col justify-center h-screen">
        <form class=" mx-auto  bg-[#72B944] shadow-2xl border-4 border-white focus:ring-lime-300 columns px-7 py-1.5 rounded-2xl w-[500px] h-[400px]">
            ...
            <div class="mb-5">
            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 px-2"  >Username</label>
            <input type="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-lime-500 focus:border-lime-500 block mt-2 rounded-2xl w-full p-2.5" placeholder="Username" required />
            </div>
            <div class="mb-5">

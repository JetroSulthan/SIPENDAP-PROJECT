        ...
        @csrf    
            ...
            <div class="inline-flex ">
              ...
              <div class="relative flex z-0 w-full mb-1 group">
                  ...
                  <input type="text" name="tempat_lahir" id="tempat" class="block py-2.5 px-4 text-sm text-[#72B944] w-[120px] border-[#72B944] focus:border-[#72B944] border-2 rounded-3xl" placeholder="Tempat Lahir" value="{{ $keltani->tempat_lahir }}" required />

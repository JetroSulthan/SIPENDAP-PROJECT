        ...
        @csrf    
            ...
            <div class="relative z-0 w-full mt-0.5 group">
              <label for="password" class="px-4">Password</label>
                <input type="password" name="password" id="password" class="block mb-4 py-2.5 px-4 text-sm text-[#72B944] w-[800px] border-[#72B944] focus:border-[#72B944] border-2 rounded-3xl" value="{{ $user->password }}" required />
            </div>
            <div class="mb-3">
            ...
            {{-- @if ($keltani) --}}
                {{-- @foreach ($pemerintah as $pm ) --}}
                    ...
                    <div class="relative z-0 w-full group">
                        <input type="text" name="nip" id="nip" class="block py-2.5 px-4 text-sm text-[#72B944] w-[800px] border-[#72B944] focus:border-[#72B944] border-2 rounded-3xl" placeholder="NIP" value="{{ $keltani->nip }}" required/>
                    </div>
                    <div class="relative z-0 w-full group">
                        <input type="text" name="nomor_sk" id="nomor_sk" class="block py-2.5 px-4 text-sm text-[#72B944] w-[800px] border-[#72B944] focus:border-[#72B944] border-2 rounded-3xl" placeholder="Nomor SK" value="{{ $keltani->nomor_sk }}" required/>
                    </div>
                {{-- @endforeach
            @endif --}}
                <div class=" px-80">

...
@section('container')
    ...
    <aside id="default-sidebar" class=" mt-[55px] left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
     ...
     <div class=" -space-y-[650px]  px-[400px] flex flex-col">
      <table class="table-auto w-[500px] divide-y divide-gray-200">
          ...
          <tbody>
              ...
              <tr>
                  ...
                  <td class="tb-col tb-col-md">
                      <div class=" px-2 py-1 fs-6 lh-sm">{{ $value->nama_lengkap }}</div>
                  </td>
                  <td class="tb-col tb-col-md">

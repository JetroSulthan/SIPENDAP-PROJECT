...
<div class=" flex justify-center h-[90vh]">
    ...
    <div class="flex flex-col space-y-8 justify-center items-center mx-auto relative mt-20 mb-8 bg-white w-[600px] rounded-[30px]">
        <div class="mt-4">
            ...
            <p class="text-center font-medium text-xl">Akun Kelompok Tani Sudah Disimpan</p>
        </div>
        ...
        <div class="inline-flex ">
            <a href="/keltani" class=" "> 
                ...
                <button type="submit" class=" mt-2 text-white bg-[#72B944] hover:bg-[#5D9B35] focus:ring-2 focus:outline-none focus:ring-[#72B944] font-medium rounded-full text-[15px] w-full sm:w-auto px-5  py-1.5 text-center">Kembali ke Daftar Akun Kelompok Tani</button>
            </a>
        </div>
    </div>
</div>
